...
class Metro(Map):
    ...
    def UNDERPASS_HALL(self, S: V = (0, 0, 0)) -> None:
        # Left backward wall
        BLF = S + (UNDERPASS_HALLWAY_DEPTH + UNDERPASS_HALLWAY_HEIGHT) * V.DOWN + (UNDERPASS_ENTRANCE_WIDTH + UNDERPASS_SIDEWALK_WIDTH) * V.BACKWARD
        BLC = S + UNDERPASS_HALLWAY_DEPTH * V.DOWN + (UNDERPASS_ENTRANCE_WIDTH + UNDERPASS_SIDEWALK_WIDTH) * V.BACKWARD
        ...
        # Left forward wall
        TLF = S + (UNDERPASS_HALLWAY_DEPTH + UNDERPASS_HALLWAY_HEIGHT) * V.DOWN + UNDERPASS_SIDEWALK_WIDTH * V.FORWARD
        TLC = S + UNDERPASS_HALLWAY_DEPTH * V.DOWN + UNDERPASS_SIDEWALK_WIDTH * V.FORWARD
        ...
        # Right backward wall
        BRF = S + (UNDERPASS_HALLWAY_DEPTH + UNDERPASS_HALLWAY_HEIGHT) * V.DOWN + (UNDERPASS_ENTRANCE_WIDTH + UNDERPASS_SIDEWALK_WIDTH) * V.BACKWARD + UNDERPASS_HALLWAY_WIDTH * V.RIGHT
        BRC = S + UNDERPASS_HALLWAY_DEPTH * V.DOWN + (UNDERPASS_ENTRANCE_WIDTH + UNDERPASS_SIDEWALK_WIDTH) * V.BACKWARD + UNDERPASS_HALLWAY_WIDTH * V.RIGHT
        ...
        # Left forward wall
        TRF = S + (UNDERPASS_HALLWAY_DEPTH + UNDERPASS_HALLWAY_HEIGHT) * V.DOWN + UNDERPASS_SIDEWALK_WIDTH * V.FORWARD + UNDERPASS_HALLWAY_WIDTH * V.RIGHT
        TRC = S + UNDERPASS_HALLWAY_DEPTH * V.DOWN + UNDERPASS_SIDEWALK_WIDTH * V.FORWARD + UNDERPASS_HALLWAY_WIDTH * V.RIGHT

...
class Metro(Map):
    ...
    def UNDERPASS_SIDEWALK(self, S: V = (0, 0, 0)) -> None:
        ...
        BLO = BLI + (STREET_LANE_WIDTH - UNDERPASS_ENTRANCE_WIDTH - STREET_SIDEWALK_CURB) * V.BACKWARD
        BRO = BLO + (UNDERPASS_ENTRANCE_SLOPE + UNDERPASS_HALLWAY_WIDTH + UNDERPASS_ENTRANCE_STAIRS) * V.RIGHT
        BRI = BRO + (STREET_LANE_WIDTH - UNDERPASS_ENTRANCE_WIDTH - STREET_SIDEWALK_CURB) * V.FORWARD
